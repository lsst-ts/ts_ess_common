...
from lsst.ts.ess.common.data_client import SiglentSSA3000xSpectrumAnalyzerDataClient
...
class SiglentSSA3000xDataClientTestCase(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
        ...
        config_schema = SiglentSSA3000xSpectrumAnalyzerDataClient.get_config_schema()
    ...
    def create_data_client(self) -> SiglentSSA3000xSpectrumAnalyzerDataClient:
        ...
        SiglentSSA3000xSpectrumAnalyzerDataClient:
            The DataClient.
        """
        data_client = SiglentSSA3000xSpectrumAnalyzerDataClient(
            config=self.config,
        ...
        async with self.create_controller():
            ...
            try:
                ...
                assert telemetry.startFrequency == pytest.approx(
                    SiglentSSA3000xSpectrumAnalyzerDataClient.start_frequency
                )
                assert telemetry.stopFrequency == pytest.approx(
                    SiglentSSA3000xSpectrumAnalyzerDataClient.stop_frequency
                )
