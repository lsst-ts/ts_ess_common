...
from lsst.ts.ess.common import compute_dew_point_magnus, get_circular_mean_and_std_dev
from lsst.ts.ess.common.data_client import (
...
class Young32400DataClientTestCase(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
        ...
        config_schema = Young32400WeatherStationDataClient.get_config_schema()
    ...
    def create_data_client(
        ...
        return Young32400WeatherStationDataClient(
    ...
    async def test_raw_data_generator(self) -> None:
        field_name_index = {
            field_name: i
            for i, field_name in enumerate(Young32400RawDataGenerator.stat_names)
        }
        ...
        for field_name, mean, expected_raw in (
            ...
            data_gen = Young32400RawDataGenerator(
        ...
        assert values.shape == (
            num_items,
            len(Young32400RawDataGenerator.stat_names),
        )
        ...
        for field_name, field_index in field_name_index.items():
            ...
            if field_name == "rain_rate":
                ...
                if delta_counts < 0:
                    delta_counts += Young32400RawDataGenerator.max_rain_tip_count
                ...
                mean, std = get_circular_mean_and_std_dev(wind_direction_deg)
    ...
    async def check_air_flow(
        self, config: types.SimpleNamespace, data_gen: Young32400RawDataGenerator
    ) -> None:
