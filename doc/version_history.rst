...
- Avoided superfluous error messages and raised exception when errors for too long reading telemetry. (`OSW-1500 <https://rubinobs.atlassian.net//browse/OSW-1500>`_)
