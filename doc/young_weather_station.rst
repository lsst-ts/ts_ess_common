...
* Rain tip (VIN4) counts conversion from page 1 of the the tipping bucket rain gauge manual indicates that each tip count value corresponds to 0.1 mm.
  This means that the rain tip scale needs to be::
