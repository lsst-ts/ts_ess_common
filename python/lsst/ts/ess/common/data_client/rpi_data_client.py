...
from ..constants import PASCALS_PER_MILLIBAR, ResponseCode, SensorType
...
"""
    ...
    def get_telemetry_dispatch_dict(self) -> dict[SensorType, Callable]:
        return {
            SensorType.TEMPERATURE: self.process_temperature_telemetry,
            SensorType.HX85A: self.process_hx85a_telemetry,
            SensorType.HX85BA: self.process_hx85ba_telemetry,
            SensorType.CSAT3B: self.process_csat3b_telemetry,
            SensorType.WINDSONIC: self.process_windsonic_telemetry,
        }
